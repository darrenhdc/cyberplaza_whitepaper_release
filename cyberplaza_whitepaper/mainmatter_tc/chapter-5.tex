...
營收模式優先考慮SaaS訂閱作為主要收益來源（40--50\%）以確保可預測性，團購作為輔助收益（5--10\%），考慮到早期規模這更為現實，以及API服務（15--20\%）作為高利潤、可擴展的收益來源。保守預測基於第3年0.01\%的市場滲透率。
...
代幣分配強調社群優先，55\% 分配給社群激勵（社群優先方針），12.5\% 分配給投資者，15\% 分配給團隊以實現更強的一致性。流動性提供者激勵已整合至社群分配結構中。
